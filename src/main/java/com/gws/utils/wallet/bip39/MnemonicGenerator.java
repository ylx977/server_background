...
//import static org.bip39.ByteUtils.next11Bits;
...
public final class MnemonicGenerator {
    ...
    static byte firstByteOfSha256(final byte[] entropy) {
      //  SHA256Digest sha256 = new SHA256Digest(entropy);
        Sha256Hash hash2 = new Sha256Hash(entropy);
        final byte[] hash =hash2.getBytes();
